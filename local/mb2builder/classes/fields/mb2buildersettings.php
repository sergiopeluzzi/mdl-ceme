	...
	class admin_setting_configmb2buildersettings extends admin_setting
	{
		...
		public function local_mb2builder_settings_get_settings_template ($config_fields, $type)
		{
			...
			foreach ($config_tabs as $tab=>$tname)
			{
				...
				$output .= '<li class="' . $isactive . '"><a class="nav-link' . $isactive . '" data-toggle="tab" href="#' . $type . '-' . $tab . '">' . $tname . '</a></li>';
			}
		...
		public function local_mb2builder_font_icons()
		{
			...
			$output .= '<ul class="nav nav-tabs">';
			$output .= '<li class="active"><a class="active show" data-toggle="tab" href="#tab-font-icons-fa">Font Awesome</a></li>';
		...
		public function local_mb2builder_import_export($id)
		{
			...
			$output .= '<ul class="nav nav-tabs">';
			$output .= '<li class="active"><a class="active show" data-toggle="tab" href="#tab-import' . $id . '">' . get_string('import','local_mb2builder') . '</a></li>';
			...
			$output .= '<a href="' . $this->local_mb2builder_settings_export_page($id) . '" class="btn btn-primary" download><i class="fa fa-download"></i> ' .
			get_string('downloadcontent' . $id,'local_mb2builder') . '</a>';
			$output .= '</div>';
